  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Our Story — Rajadhaniyam" },
      {
        ...
        content: "Ancient grains, fair farm partnerships and slow milling — the Rajadhaniyam story.",
      },
    ],
  }),
  component: About,
...
const values = [
  { title: "Honest Sourcing", text: "We buy direct, pay above mandi rates and name every farm region." },
  ...
  return (
    <SiteLayout>
      <section className="relative overflow-hidden bg-charcoal text-paper">
        <img src={heroImg} alt="" loading="lazy" className="absolute inset-0 h-full w-full object-cover opacity-40" />
      ...
      <section className="mx-auto grid max-w-7xl items-center gap-14 px-6 py-20 lg:grid-cols-2">
        ...
        <div className="space-y-5">
          ...
          <h2 className="font-display text-4xl leading-tight">From a home mill to a pantry brand</h2>
