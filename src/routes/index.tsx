...
import { bestsellers, categories } from "@/lib/shop-data";
...
const testimonials = [
  ...
  {
    quote: "Beautiful packaging, honest ingredients and quick delivery. My default pantry order now.",
    name: "Divya Menon",
    city: "Chennai",
  },
];
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-6 py-24 lg:py-36">
          <div className="max-w-2xl space-y-7">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              ...
              <BtnLink to="/about" size="lg" className="border border-paper/30 bg-transparent text-paper hover:bg-paper/10">
                Our Story
              </BtnLink>
            </div>
          </div>
          ...
          {categories.map((c, i) => (
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 p-6">
                ...
                <span className="eyebrow mt-3 inline-block text-[0.6rem] text-gold">
                  Explore →
                </span>
              </div>
            </Link>
