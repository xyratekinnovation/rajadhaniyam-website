...
export const Route = createFileRoute("/order-success")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Thank you for your Rajadhaniyam order. It is being packed now." },
    ...
    <SiteLayout>
      <section className="mx-auto max-w-2xl px-6 py-24 text-center">
        ...
        <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
          Order <span className="text-charcoal">#RJD-24817</span> is confirmed. We will send tracking
          details to your email as soon as it leaves our Coimbatore packhouse.
        </p>
